...
from .main_position_sort import PositionSortOptions
from .main_position_sort_trial import PositionSortTrialOptions
...
parse_command_args(
    ...
    parsers=dict(
        ...
        sa=PositionSortOptions,
        spv=PositionSortTrialOptions,
